...
Some cases where it makes sense to use this:

1. You want to integrate with a mod and it requires access to its data, tables or functions that will only be present once that has done loading.
